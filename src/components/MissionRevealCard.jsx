...
// 뽑힌/완료된 미션을 "블랙 카드 + 점선 구분선 + 하단 일러스트" 스타일로 보여주는 카드
export default function MissionRevealCard({ mission, label = 'Now', onClick, statusBadge }) {
  return (
    <button
      onClick={onClick}
      className="w-full h-full rounded-xl bg-black border border-white/10 flex flex-col overflow-hidden text-left"
    >
